...
var win=$("<div class=\"messager-body\"></div>").html("<div style='float:left;height:20px;width:20px;'></div>"+opts.msg).appendTo("body");
win.window(opts);
...
var _265="<div class='messager-content'>"+msg+"</div>";
switch(icon){
case "error":
...
var _268="<div class=\"messager-icon messager-question\"></div>"+"<div class='messager-content'>"+msg+"</div>"+"<div style=\"clear:both;\"/>";
var _269={};
...
var _26b="<div class=\"messager-icon messager-question\"></div>"+"<div class='messager-content'>"+msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input\" type=\"text\"/></div>";
var _26c={};
